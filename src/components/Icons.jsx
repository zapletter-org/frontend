// Reusable line-style icon components
...
export function ExternalLinkIcon({ size = 20, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function EyeOffIcon({ size = 20, className = "" }) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M17.94 17.94C16.16 19.22 14.18 20 12 20 5 20 1 12 1 12a21.8 21.8 0 0 1 4.42-5.42" />
      <path d="M9.9 4.24C10.57 4.09 11.27 4 12 4c7 0 11 8 11 8a21.8 21.8 0 0 1-3.23 4.49" />
